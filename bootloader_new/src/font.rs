/// Complete 8x16 bitmap font for boot screen text rendering
...
pub static FONT_8X16: [[u8; 16]; 95] = [
    ...
    // 75: K
    [0x00,0x00,0xE6,0x66,0x6C,0x78,0x78,0x78,0x6C,0x66,0x66,0xE6,0x00,0x00,0x00,0x00],
    // 76: L
...
pub fn glyph(ch: char) -> &'static [u8; 16] {
    ...
    if idx >= 32 && idx <= 126 {
        ...
        &FONT_8X16[0] // space for unknown chars
    }
}
